...
Studio boots at `http://127.0.0.1:4000`, or the next free port if that one is taken (it tries a bounded range of ports and exits if none are free). Open the URL the CLI prints; from there you can trigger a training run.
