...
On an Apple Silicon Mac, `arkor start --local` runs the whole thing locally through MLX: same callbacks, same events, adapter on your disk. See [Train locally with MLX](/guides/cli/local-training).
