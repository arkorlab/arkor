...
| `model` | `SupportedModel` | Base model identifier, narrowed to the models the backend accepts today. An unsupported value is a compile error (see [Supported models](/models)). |
