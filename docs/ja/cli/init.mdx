...
```bash pnpm
pnpm dlx arkor init --yes --template triage --use-pnpm --skip-git
```
...
```bash yarn
yarn dlx arkor init --yes --template triage --use-yarn --skip-git
```
...
```bash pnpm
pnpm dlx arkor init --yes --skip-install --skip-git
```
...
```bash yarn
yarn dlx arkor init --yes --skip-install --skip-git
```
...
```bash pnpm
pnpm dlx arkor init --template translate --use-pnpm
```
...
```bash yarn
yarn dlx arkor init --template translate --use-yarn
```
