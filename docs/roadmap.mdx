...
<CardGroup cols={2}>
  ...
  <Card title="Full Gemma 4 family support" icon="layer-group" href="/sdk/create-trainer">
    ...
    Cover the full Gemma 4 family in the `model` field. Today every starter template uses `unsloth/gemma-4-E4B-it`; opening up the rest of the family lets you pick the size that fits your latency and quality budget.
  </Card>
</CardGroup>
