...
<CardGroup cols={2}>
  ...
  <Card title="Broader base model support" icon="cubes" href="/sdk/create-trainer">
    ...
    Expand support beyond the Gemma 4 family to additional open-weight model families, so the `model` field becomes a real menu instead of a single supported value.
  </Card>
