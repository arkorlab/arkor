...
| --- | --- |
| Pause a running job | Not supported. To cancel instead, use the **Cancel run** button on the job detail page, or call [`trainer.cancel()`](/sdk/trainer-control#cancel) from your own code. |
