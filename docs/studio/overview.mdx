...
| --- | --- |
| Pause a running job | Not supported. Cancelling is: a job detail page has a **Cancel run** button, and [`trainer.cancel()`](/sdk/trainer-control#cancel) does the same from your own code. |
