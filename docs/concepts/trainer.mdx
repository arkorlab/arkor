...
You can hook into the run with [lifecycle callbacks](/concepts/lifecycle): `onStarted`, `onLog`, `onCheckpoint`, `onCompleted`, `onFailed`. That is the next concept to read.
