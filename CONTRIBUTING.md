...
By contributing, you agree that your contributions are licensed under this repository's [LICENSE](LICENSE.md) (currently the MIT license). Opening a pull request is deemed to constitute this agreement.
